...
const projects: Project[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      duration: "2024 – 2026",
      technologies: ["ESP32", "FOC (Field-Oriented Control)", "4-Layer PCB Design", "DRV8313 Motor Driver", "AS5048A Magnetic Encoder", "BLDC Motor Control", "Bluetooth / WiFi", "USB-C", "C++ / Arduino Framework", "Torque, Speed and Position Control"],
  ...
  },
  {
    ...
    detail: {
      ...
      technologies: ["Compliant Mechanism Design", "Flexure Pivots (Crossed & Simple Blades)", "Negative-Stiffness Preload", "Capacitive Displacement Sensing", "Static/Force/Moment (SFM) Balancing", "Worm-Screw Actuation", "Titanium 6Al-4V & Aluminum", "CAD & Technical Drawing"],
      keyResults: [
