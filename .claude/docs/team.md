...
All six career agents know where Your Name's content lives (CV variants, `cv/data/`, `src/data/projects.ts`, translations). They also all respect the **ambitious-not-cocky** tone rule and respond in the language of the document under review.
